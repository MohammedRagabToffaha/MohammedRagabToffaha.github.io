...
//print invoice
 $(document).on('click', '.printInvoice', function(e){
  ...
  var win=  window.open("", "",
     "width=750,height=650,top=5,left=5,toolbars=no,scrollbars=yes,status=no,resizable=yes");
  var htmlelemnt="<div class='row'><div class='col-md-12'><img  style='width:180px;height:105px;margin-left: auto;margin-right: auto;display: block;' src='/img/logoToPrint.png'/> </div></div>"; 
   ...
   win.document.write('<html><head><title>Print it!</title><link href="css/bootstrap.min.css" rel="stylesheet" /><script src="js/jquery-2.2.4.min.js"></script><link rel="stylesheet" type="text/css" href="css/printer.css"></head><body>');     
       htmlelemnt +="<div class='row con'  style='margin-top:10px'><div class='col-md-6'>";
   ...
   htmlelemnt +="</div>";
    ...
    htmlelemnt +="<div class='row con' ><div class='col-lg-6'></div><div class='col-lg-6' style='margin-top:1px'><div class='row con' >";
    ...
    htmlelemnt +="<div class='row con' > <div class='col-md-12'><div class='table-responsive' style='margin-top:15px'><table class='table table-bordered' id='catToPrint_table1'><thead><tr style='background-color: #FBB900;color: #B80303'><th width='45%'>الصنف</th><th width='22%'>الكمية</th><th width='16%'>سعر الطن</th><th width='17%'>سعر التكلفة</th></tr></thead>";
          ...
          if (plusfeeAmountItems != null) {
           ...
           htmlelemnt +="<div class='table-responsive otherFeesDiv1' style='margin-top:15px;width:50%'><table class='table table-bordered' id='otherServicesPrint_table1'><thead><tr style='background-color: #FBB900;color: #B80303'><th width='60%'>خدمات إضافيه</th><th width='40%'>المبلغ</th></tr></thead>"
          }
        ...
        htmlelemnt +="</table></div></div><div class='col-lg-6'style='margin-top:15px'><div class='row con' ><label id='totalWithoutDiscount1' style='position:relative;float:left;font-size:13px;color:gray;width:250px'>"+totalWithoutDiscount+"</label></div>";
...
win.document.write("<div class='row' style='position: fixed;bottom:30px;width: 100%;'><label style='margin-left: auto;margin-right: auto;float:left;position:relative;font-size:11px;color:gray;width:400px'>"+"الاستبدال لا يتم إلا بالفاتوره خلال 5 ايام من تاريخ الشراء"+"</label></div></body></html>"); 
win.document.close();
setTimeout(function(){
    win.focus();
    win.print();
